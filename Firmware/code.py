...
MAC1 = KC.MACRO("chargoggagoggmanchauggagoggchaubunagungamaugg")
...
SPEC = KC.MACRO(
    "leave me alone\n"
    "i'm filling out my special olympics application\n"    
)
...
display.entries = [
    ...
    TextEntry(text="Cubitpad v3.5", x=0, y=0),
    icondisp,
